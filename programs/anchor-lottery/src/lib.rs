...
#[constant]
pub const URL: &str = "https://raw.githubusercontent.com/alxn787/anchor-lottery/refs/heads/main/metadata.json";
...
pub mod anchor_lottery {
    ...
    use anchor_spl::metadata::{create_master_edition_v3, create_metadata_accounts_v3, mpl_token_metadata::types::{CollectionDetails, Creator, DataV2}, set_and_verify_sized_collection_item, sign_metadata, CreateMasterEditionV3, CreateMetadataAccountsV3, SetAndVerifySizedCollectionItem, SignMetadata};
    ...
    pub fn buy_ticket(ctx: Context<BuyTicket>, ticket_number: u64) -> Result<()> {
        let clock = Clock::get()?;
